...
# Introductory R for Transport Applications
...
Prior experience with R or an understanding of common geographic and transport-related datasets is highly recommended.
participants will also benefit from experience with GIS.

In the first day we will cover general concepts in efficient R programming and the basics of spatial data classes in R. Building on this foundation the second day will cover the application of the skills developed in Day 1 to transport datasets, with a focus on geographical transport data.
